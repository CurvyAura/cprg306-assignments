...
export default function NewItem({ onAddItem }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="border border-gray-500 p-4 mb-4 bg-gray-900 text-white w-full">
            ...
            <div className="mb-4">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button 
                        ...
                        className="bg-blue-600 hover:bg-blue-700 disabled:bg_gray-600 disabled:cursor-not-allowed text-white font-bold py-2 px-4 rounded"
                    >+</button>
                </div>
            </div>
